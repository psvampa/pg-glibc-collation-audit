...
about it. See [Known limitations](limitations.md). Its RHEL9→RHEL10 verdict
...
### The full run, and the evidence for each verdict
...
### The full run, and how step 5 clears a step-4 locale
...
- **RHEL8 to RHEL9** (glibc 2.28 to 2.34): full method run, plus empirical
  ...
  limitations](limitations.md) was measured on these same two nodes.

...
| [../examples/](../examples/) | Real output from both pairs, a confirmation SQL script for each, and the `C.UTF-8` probe output that is the only published evidence for that locale's order |
